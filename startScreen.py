...
title = pygame.image.load(os.path.join('imgs', 'title.png'))
back = pygame.image.load(os.path.join('imgs', 'back.png'))
course = pygame.image.load(os.path.join('imgs', 'course1.png'))
